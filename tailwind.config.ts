  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "undefined-icon": "url('/images/icons/base.jpg')",
        "common-icon": "url('/images/icons/common.jpg')",
        "magic-icon": "url('/images/icons/magic.jpg')",
        "rareicone": "url('/images/icons/rare.jpg')",
        "legendary-icon": "url('/images/icons/legendary.jpg')",
        "set-icon": "url('/images/icons/set.jpg')",
      },
    },
  },
  safelist: [
