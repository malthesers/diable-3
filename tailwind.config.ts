  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "undefined-icon": "url('/images/nameplates/base.jpg')",
        "common-icon": "url('/images/nameplates/common.jpg')",
        "magic-icon": "url('/images/nameplates/magic.jpg')",
        "rareicone": "url('/images/nameplates/rare.jpg')",
        "legendary-icon": "url('/images/nameplates/legendary.jpg')",
        "set-icon": "url('/images/nameplates/set.jpg')",
      },
    },
  },
  safelist: [
