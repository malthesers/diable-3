  ...
  return (
    <ModalTemplate showModal={showInstructions} closeModal={() => toggleShowInstructions(false)} title='Instructions'>
      <div className='text-lg sm:text-xl text-center space-y-2'>
        ...
        <p><span className='font-semibold'>Common</span> and <span className='font-semibold text-magic'>magic</span> items constitute only <span className='italic'>unique</span> items, e.g. transmogs commons and Darkening of Tristram magic items.</p>
