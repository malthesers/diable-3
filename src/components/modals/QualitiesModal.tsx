...
export default function QualitiesModal() {
  ...
  function updateChosen(quality: keyof typeof chosen) {
    toggleChosen(quality)
    resetGame()
  }
    ...
    >
      ...
      <div className='grid grid-cols-2 sm:grid-cols-3 gap-4 mt-2'>
        { Object.entries(chosen).map(([quality, active]) => 
          <div onClick={() => updateChosen(quality as keyof typeof chosen)} key={quality} className={'grid bg-undefined-icon text-center cursor-pointer duration-200 hover:shadow-quality-inner'}>
