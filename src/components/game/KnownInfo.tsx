  ...
  return (
    <div className="w-[330px] sm:w-[400px] mx-auto bg-black border-grey border-4 p-1 space-y-2">
      <div className={ `bg-${known.quality}` + ' w-full aspect-[350/40] bg-no-repeat bg-cover grid p-2'}>
        <p className="text-red-800 text-lg leading-none tracking-wider uppercase place-self-center">{known.name}</p>
      </div>
      <div className="grid grid-cols-[5rem_auto] border-grey border-2 gap-4 p-2">
        ...
        <div className="font-sans capitalize">
          <p className={ `text-${known.quality}` + ' flex gap-1'}>
            ...
            <span>Gloves</span>
            <span className="ml-auto text-neutral-500">Hands</span>
          </p>
        </div>
      </div>
    </div>
